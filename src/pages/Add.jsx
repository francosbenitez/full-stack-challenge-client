                ...
                <div className="w-full flex justify-center">
                    <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        ...
                        <div class="flex items-center justify-between">
                            <button type="submit" class="bg-primary border-2 border-primary border-opacity-90 hover:bg-opacity-90 text-background font-bold py-2 px-4 rounded">
                                Create
                            </button>
                            <Link to="/home" style={{backgroundImage: 'none'}}>
                                <button class="bg-background border-2 border-primary border-opacity-90 hover:bg-opacity-10 text-primary font-bold py-2 px-4 rounded">
                                    Cancel
                                </button>
                            </Link>
                        </div>
